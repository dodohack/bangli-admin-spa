...
export class BaseActions {
    ...
    static searchComplete(results: Post[]): Action {
        return {
            type: BaseActions.SEARCH_COMPLETE,
            payload: results
        };
    }
    ...
    static loadPostsSuccess(posts: Post[]): Action {
        return {
            type: BaseActions.LOAD_POSTS_SUCCESS,
            payload: posts
        };
    }
    ...
    static loadPostsFail(): Action {
        return {
            type: BaseActions.LOAD_POSTS_FAIL,
        };
    }
    ...
    static batchEditPosts(ids: number[]): Action {
        return {
            type: BaseActions.BATCH_EDIT_POSTS,
            payload: ids
        };
    }
    ...
    static cancelBatchEditPosts(): Action {
        return {
            type: BaseActions.CANCEL_BATCH_EDIT_POSTS
        };
    }
    ...
    static batchDeletePosts(ids: number[]): Action {
        return {
            type: BaseActions.BATCH_DELETE_POSTS,
            payload: ids
        };
    }
    ...
    static batchOfflineEditPosts(ids: number[]): Action {
        return {
            type: BaseActions.BATCH_OFFLINE_EDIT_POSTS,
            payload: ids
        };
    }
    ...
    static batchLockPosts(ids: number[]): Action {
        return {
            type: BaseActions.BATCH_LOCK_POSTS,
            payload: ids
        };
    }
    ...
    static batchEditPreviousPost(): Action {
        return {
            type: BaseActions.BATCH_EDIT_PREVIOUS_POST
        };
    }
    ...
    static batchEditNextPost(): Action {
        return {
            type: BaseActions.BATCH_EDIT_NEXT_POST
        };
    }
    ...
    static loadPostSuccess(post: Post): Action {
        return {
            type: BaseActions.LOAD_POST_SUCCESS,
            payload: post
        };
    }
    ...
    static loadPostFail(): Action {
        return {
            type: BaseActions.LOAD_POST_FAIL,
        };
    }
    ...
    static applyRevision(ids: number[]): Action {
        return {
            type: BaseActions.APPLY_REVISION,
            payload: ids
        };
    }
    /*
     ...
     return {
     type: BaseActions.SAVE_POST_AS_PENDING,
     payload: post
     };
     }
     ...
     return {
     type: BaseActions.SAVE_POST_AS_DRAFT,
     payload: post
     };
     }
     ...
     return {
     type: BaseActions.SAVE_POST_AS_PUBLISH,
     payload: post
     };
     }
     */
    ...
    static savePostSuccess(post: Post): Action {
        return {
            type: BaseActions.SAVE_POST_SUCCESS,
            payload: post
        };
    }
    ...
    static savePostFail(): Action {
        return {
            type: BaseActions.SAVE_POST_FAIL
        };
    }
    ...
    static removeCategory(cat_id: number): Action {
        return {
            type: BaseActions.REMOVE_CATEGORY,
            payload: cat_id
        };
    }
    ...
    static refreshActivityStatus(activities: Activity[]): Action {
        return {
            type: BaseActions.REFRESH_ACTIVITY_STATUS,
            payload: activities
        };
    }
}
