...
export default function (state = initialState, action: Action): TopicsState {
    switch (action.type)
    {
        ...
        case TopicActions.BATCH_EDIT_TOPICS: {
            return {
                ids: [...state.ids],
        ...
        case TopicActions.CANCEL_BATCH_EDIT_TOPICS: {
            return {
                ids: [...state.ids],
                editing: [],
                entities: Object.assign({}, state.entities),
        ...
        case TopicActions.BATCH_EDIT_PREVIOUS_TOPIC: {
        ...
        case TopicActions.BATCH_EDIT_NEXT_TOPIC: {
            // DO NOTHING IF WE ARE NOT FAST EDITING SINGLE TOPIC
            if (state.editing.length !== 1) return state;
        ...
        case TopicActions.SAVE_TOPIC_SUCCESS:
        ...
        case TopicActions.REMOVE_CATEGORY: {
            ...
            if (action.type == TopicActions.REMOVE_POST) key = 'topics';
