...
export const SIDEBAR_MENUS = [
    ...
    {slug: 'topic',     name: '专题',    role: 'editor',  icon_style: 'fa fa-lg fa-file-text-o'},
    {slug: 'offer',     name: '优惠',    role: 'editor',  icon_style: 'fa fa-lg fa-tags'},
    {slug: 'advertise', name: '广告',    role: 'editor',  icon_style: 'fa fa-lg fa-money'},
    {slug: 'bbs',       name: '社区',    role: 'editor',  icon_style: 'fa fa-lg fa-comments'},
    {slug: 'page',      name: '页面',    role: 'editor',  icon_style: 'fa fa-lg fa-file-o'},
